...
image:.github/badges/jacoco.svg["Coverage"]
<img src="https://raw.githubusercontent.com/rinaudosal/designpatterns/master/.github/badges/jacoco.svg">

Terzo (.github/badges/jacoco.svg)
Quarto (ddd)[.github/badges/jacoco.svg]
