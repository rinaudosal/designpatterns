...
object Paths {
     ...
     */
    @Location("/management/device/{deviceId}") class deleteDevice(val mMCAppCode: kotlin.String, val deviceId: kotlin.String)
     ...
     */
    @Location("/message/check") class messageCheck(val mMCAppCode: kotlin.String, val mMCMessageId: kotlin.String? = null, val mMCMessageUuid: kotlin.String? = null)
