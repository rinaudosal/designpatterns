...
echo Remember to update afb-mock-deployment.yml with new version
...
docker build -t eu.gcr.io/az4u-dev/afb-mock:$newVersion .
echo image tagged eu.gcr.io/az4u-dev/afb-mock:$newVersion

# login to google cloud
gcloud container clusters get-credentials cluster-1 --zone europe-west1-b --project az4u-dev

# push to google cloud
gcloud docker -- push eu.gcr.io/az4u-dev/afb-mock:$newVersion
echo image pushed eu.gcr.io/az4u-dev/afb-mock:$newVersion

# apply deployment
kubectl apply -f kubernetes/afb-mock-deployment.yml
