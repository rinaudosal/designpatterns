...
public class InstrumentSearchByCodeFilter   {
  ...
  public InstrumentSearchByCodeFilter instrumentExternalCode(String instrumentExternalCode) {
  ...
  **/
  ...
  public InstrumentSearchByCodeFilter values(List<String> values) {
    this.values = values;
    return this;
  }

  public InstrumentSearchByCodeFilter addValuesItem(String valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InstrumentSearchByCodeFilter instrumentSearchByCodeFilter = (InstrumentSearchByCodeFilter) o;
    return Objects.equals(this.instrumentExternalCode, instrumentSearchByCodeFilter.instrumentExternalCode) &&
        Objects.equals(this.values, instrumentSearchByCodeFilter.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstrumentSearchByCodeFilter {\n");
