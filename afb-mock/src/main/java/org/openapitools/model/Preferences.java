...
public class Preferences   {
  ...
  @Valid
  private List<KeyValue> preferences = null;

  public Preferences preferences(List<KeyValue> preferences) {
    this.preferences = preferences;
    return this;
  }

  public Preferences addPreferencesItem(KeyValue preferencesItem) {
  ...
  **/
  ...
  public List<KeyValue> getPreferences() {
    return preferences;
  }

  public void setPreferences(List<KeyValue> preferences) {
    this.preferences = preferences;
  }
